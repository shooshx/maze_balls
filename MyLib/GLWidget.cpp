...
{
    int mod = ((event->modifiers() & Qt::ControlModifier) != 0) ? KEYMOD_CTRL : 0;
    mod |= ((event->modifiers() & Qt::ShiftModifier) != 0) ? KEYMOD_SHIFT : 0;
    mod |= ((event->modifiers() & Qt::AltModifier) != 0) ? KEYMOD_ALT : 0;
